...
public final class RuntimeState {
  ...
  public void syncPlayerGrowth(){int oldMaxHp=player.maxHp,oldMaxMp=player.maxMp;player.maxHp=rpg.maxHpGrowth();player.maxMp=rpg.maxMpGrowth();if(player.maxHp>oldMaxHp)player.hp=Math.min(player.maxHp,player.hp+(player.maxHp-oldMaxHp));else player.hp=Math.min(player.hp,player.maxHp);if(player.maxMp>oldMaxMp)player.mp=Math.min(player.maxMp,player.mp+(player.maxMp-oldMaxMp));else player.mp=Math.min(player.mp,player.maxMp);}

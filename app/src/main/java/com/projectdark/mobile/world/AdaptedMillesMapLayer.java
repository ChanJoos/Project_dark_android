...
public final class AdaptedMillesMapLayer {
  ...
  private static final List<Surface> SURFACES=Collections.unmodifiableList(Arrays.asList(
      new Surface("milles_ground",SurfaceKind.GROUND,64f,48f,1664f,1168f,E,S),
      new Surface("north_cross_road",SurfaceKind.ROAD,360f,315f,1450f,405f,E,S),
      ...
      new Surface("south_spine",SurfaceKind.ROAD,700f,690f,900f,1115f,E,S),
      ...
      new Surface("south_gate",SurfaceKind.GATE,715f,1010f,865f,1168f,E,"PROTOTYPE_TARGET_PENDING")));

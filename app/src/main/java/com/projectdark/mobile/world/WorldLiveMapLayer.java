...
public final class WorldLiveMapLayer {
  ...
  public void draw(Canvas canvas){renderer.draw(canvas,world);} public WorldRuntimeAdapter.FrameSnapshot tick(float deltaSeconds){return world.tickNavigation(deltaSeconds);}
  ...
  public IsometricTileMovementController.Snapshot requestNpcApproach(String npcId){return world.requestNpcApproach(npcId);}
  ...
  public IsometricTileMovementController.Snapshot cancelForDirectInput(){return world.cancelForDirectInput();} public IsometricTileMovementController.Snapshot cancelForAction(){return world.cancelForAction();} public IsometricTileMovementController.Snapshot cancel(){return world.cancel();}

...
public final class ReagentShopInteriorRuntime implements WorldMoveTargetController.NavigationWorld,WorldMoveTargetController.Walker {
  ...
  public float x(){return x;} public float y(){return y;} public WorldMoveTargetController movement(){return movement;}
  ...
  public boolean canPlayerOccupy(float wx,float wy){return ReagentShopInteriorDef.inside(wx,wy)&&wy>=224f;}

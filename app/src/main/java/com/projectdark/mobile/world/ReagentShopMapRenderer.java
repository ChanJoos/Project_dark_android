...
public final class ReagentShopMapRenderer {
  ...
  private void tile(Canvas c,WorldRuntimeAdapter w,float x,float y){
  ...
  private void fixture(Canvas c,WorldRuntimeAdapter w,float l,float t,float r,float b,int color){

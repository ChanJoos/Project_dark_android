...
public final class ReagentShopInteriorRenderer {
  ...
  private Bitmap classic,floor,wall,counter,barrel,crate,portal;
  public ReagentShopInteriorRenderer(Context c){
    ...
    classic=load("interiors/reagent_shop/reagent_shop_classic.webp");
  ...
  public boolean ready(){return (classic!=null||floor!=null&&wall!=null&&counter!=null)&&portal!=null;}
  public void draw(Canvas c,WorldRuntimeAdapter world){
    if(c==null||world==null)return;c.drawColor(0xff120d09);
    if(classic!=null){
      // Authored classic shop plate: counter, shelving and dense interior silhouette stay coherent.
      RectF dst=new RectF(160f,92f,800f,476f);c.drawBitmap(classic,null,dst,px);
    }else{

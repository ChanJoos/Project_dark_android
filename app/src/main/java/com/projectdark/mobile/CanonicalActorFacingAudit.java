...
public final class CanonicalActorFacingAudit {
  ...
  public static boolean passes(){
    ...
    actor.endAttack();
    if(actor.presentation()!=snapshot||actor.locomotion()!=snapshot)return false;

...
public final class GameView extends View {
  ...
  private void drawReagentShop(Canvas c){if(!reagentShopOpen)return;p.setColor(0x5c000000);c.drawRect(0,0,W,H,p);modalPanel(c,430,74,918,454);text(c,"멀린의 시약상점",452,105,14);text(c,"×",887,102,14);String[] n={"코마디움","디베노뭄","쿠라눔","밀레스리콜"};String[] id={"reagent_komadium","reagent_dibenomum","reagent_curanum","recall_milles"};for(int i=0;i<4;i++){float t=128+i*70;p.setColor(0xD0191411);c.drawRect(456,t,892,t+58,p);p.setStyle(Paint.Style.STROKE);p.setStrokeWidth(1.2f);p.setColor(0xFF765335);c.drawRect(456.5f,t+.5f,891.5f,t+57.5f,p);p.setStyle(Paint.Style.FILL);Bitmap b=reagentVisuals.get(id[i]);if(b!=null){float sc=Math.min(28f/b.getWidth(),28f/b.getHeight()),dw=b.getWidth()*sc,dh=b.getHeight()*sc;c.drawBitmap(b,null,new RectF(473+(28-dw)/2,t+15+(28-dh)/2,473+(28+dw)/2,t+15+(28+dh)/2),p);}text(c,n[i],526,t+25,10);mutedText(c,"가격 원전 확인 중",526,t+44,8);}}

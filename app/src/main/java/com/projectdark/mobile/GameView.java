...
/** PROJECT DARK v0.63 - integrated world/action/NPC/combat runtime prototype. */
public final class GameView extends View {
  ...
  protected void onDraw(Canvas c){c.drawColor(Color.BLACK);c.save();c.translate(ox,oy);c.scale(scale,scale);drawWorld(c);drawNpcs(c);drawMonsters(c);drawCharacter(c);drawHud(c);drawDialogue(c);drawDeath(c);c.restore();}

...
public final class GameView extends View {
  ...
  private void trigger(Action a){if(isActing()||!state.player().alive)return;worldAdapter.cancelForAction();interaction.cancel();combat.cancelApproach();if(a==Action.SWING||a==Action.THRUST||a==Action.THROW||a==Action.PUNCH)playerFacing.beginAttack();action=a;actionClock=0;}

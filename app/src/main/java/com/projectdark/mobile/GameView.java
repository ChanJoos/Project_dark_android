  ...
  private void drawInventory(Canvas c){
    ...
    if(rows.isEmpty())text(c,"보유 아이템 없음",638,205,11);
      ...
      for(int i=0;i<limit;i++){
        ...
        text(c,row.name+" x"+row.quantity+equipped,638,203+i*19,10);
        text(c,row.itemId+req,760,203+i*19,8);
      }

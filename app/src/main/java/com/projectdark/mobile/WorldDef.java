...
public final class WorldDef {
  ...
  public static final String GEOMETRY_STATUS="ADAPTED_PROTOTYPE_VILLAGE_EXPANDED_PASS30";
  ...
  // [ADAPTED/B] Larger logical footprint: renderer scale remains independent from these coordinates.
  public static final float MIN_X=64f,MAX_X=1664f,MIN_Y=48f,MAX_Y=1168f;
  ...
  public WorldDef(){
    ...
    n.add(new NpcSpawn("milles_gate_proto","남문 안내 지점 [B]",790f,1035f,"출입구 접근 동선 검증용 프로토타입 NPC입니다.",ASSET_STATUS));
    ...
    p.add(new PortalSpawn("milles_south_exit_proto","PENDING_TARGET_MAP",790f,1135f,22f,EVIDENCE_GEOMETRY,"PROTOTYPE_DISABLED_TARGET_PENDING")); portalSpawns=Collections.unmodifiableList(p);
    ...
    o.add(new WorldObject("south_gate_anchor",ASSET_STATUS,790f,1035f,EVIDENCE_GEOMETRY,GEOMETRY_STATUS)); objects=Collections.unmodifiableList(o);

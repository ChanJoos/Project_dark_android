...
public final class CharacterRendererAudit {
  ...
  public static boolean passes(){
    ...
    if(CharacterRenderer.actionSourceIndex(CharacterRenderer.Direction.NW)!=2||CharacterRenderer.actionSourceIndex(CharacterRenderer.Direction.NE)!=3||CharacterRenderer.actionSourceIndex(CharacterRenderer.Direction.SW)!=0||CharacterRenderer.actionSourceIndex(CharacterRenderer.Direction.SE)!=1)return false;

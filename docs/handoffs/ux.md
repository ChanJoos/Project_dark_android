...
## 2026-09-10 15:59 KST — manual UX pass

Branch: `agent/ux/manual-20260910-1559`

### Repository state
- Latest `main`: `3b58a8d08805cf9031466fe0c50d56e17aa1344d`.
- `GameView.java` on main remains v0.67.
- World branch `agent/world/20260910-1455` now exposes `WorldCameraTransform` and `WorldMoveTargetController`, including screen↔world conversion, WALK/path target execution, replacement/cancel semantics, and movement status.
...
- `MainActivity` now shows a short startup onboarding toast: `전투: 몬스터 선택 → ATK / SKILL / MAGIC`.
- This documents the currently available combat interaction sequence without inventing unavailable AUTO or map-tap movement behavior.

### Boundary preservation
- No world/camera/collision/pathfinding/portal logic was copied into UX-owned code.
...
### Next UX pass
- Re-check main first for World integration. If merged, tap-to-move wiring is the immediate P0 and should supersede secondary polish work.
